  ...
  <section>
    ...
    <el-table :data="jobs" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%">
      ...
      <el-table-column label="操作" width="150" fixed="right" v-if="this.utype == '1' ? true : false">
        <template slot-scope="scope">
          <el-button size="small" @click="sendResume(scope.$index, scope.row)" type="primary">投递简历</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-col :span="24">
      ...
      <!-- <el-pagination background layout="prev, pager, next" :total="total" style="text-align: center; 
      margin-top: 15px" :page-size="pageSize" @current-change="handleCurrentChange"> </el-pagination> -->
      <!-- <div class="block"> -->
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :page-sizes="[5, 10, 15, 20]" :page-size="100" layout="total, sizes, prev, pager, next, jumper" :total="total" style="text-align: center; margin-top: 15px"> </el-pagination>
      <!-- </div> -->
    </el-col>
...
<script>
import { getJobListPage, removeJob, batchRemoveUser, editJob, addJob, sendStudentResume } from '@/api/api.js'
