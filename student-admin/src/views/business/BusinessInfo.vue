            ...
            <div>
              <el-form :model="BusinessInfo" :rules="BusinessInfoRules" ref="BusinessInfo" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item>
                  ...
                  <el-button @click="$refs.BusinessInfo.resetFields()" type="warning">重置</el-button>
                </el-form-item>
              </el-form>
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      BusinessInfoRules: {
        businessName: [{ required: true, message: '请输入企业名称', trigger: 'blur' }],
        businessType: [{ required: true, message: '请输入企业类型', trigger: 'blur' }],
        businessPerson: [{ required: true, message: '请输入企业规模', trigger: 'blur' }],
